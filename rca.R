...
# Función para calcular la matriz de Ventajas Comparativas
# Reveladas (RCA, en inglés) por el método de Balassa

# Nota: esta función será parte de un paquete con indicadores
